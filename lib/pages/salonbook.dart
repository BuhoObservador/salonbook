...
class _SalonBookState extends State<SalonBook> {
  ...
  void _refreshDataOnTabChange(int index) {
    // If navigating to home tab (index 0), refresh appointments
    if (index == 0) {
      setState(() {
        _appointmentsFuture = model.getUserAppointments();
      });
            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                background: Stack(
                  fit: StackFit.expand,
                  children: [
                    // Salon Image Background
                    if (salonInfo?.images != null && salonInfo!.images.isNotEmpty)
                      Image.network(
                        salonInfo!.images[0], // Your salon image
                        fit: BoxFit.cover,
              ...
              actions: [
                // Your existing cart icon with badge
                Consumer<Model>(
      ...
      children: [
        ...
        FutureBuilder<List<Service>>(
          ...
          builder: (context, snapshot) {
            ...
            // Show just the first 4 services
      ...
      children: [
        ...
        FutureBuilder<List<Appointment>>(
          ...
          builder: (context, snapshot) {
            ...
            // Find upcoming appointments with better date logic
            final now = DateTime.now();
            final today = DateTime(now.year, now.month, now.day);
            final upcomingAppointments = snapshot.data!
                .where((a) {
              // Convert appointment date to date-only (without time)
              final appointmentDate = DateTime(a.date.year, a.date.month, a.date.day);

              // Include if it's a future date OR same day + active status
            ...
            // Sort by date and get next appointment
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      _refreshDataOnTabChange(2);  // Also call here
                    },
  ...
  Widget _buildSalonInfoSection(BuildContext context, SalonInfo? salonInfo) {
    ...
    // Define proper day order starting with Sunday
    final dayOrder = [
      'sunday',
      'monday',
      'tuesday',
    ...
    // Day name mapping for proper display
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                // Properly ordered opening hours
                Container(
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
                    color: Colors.black,
