...
class _MyOrdersScreenState extends State<MyOrdersScreen> {
      ...
      children: [
        ...
        Expanded(
          child: ElevatedButton(
            onPressed: () {
              _showOrderOptionsDialog(context, order);
            },
            style: ElevatedButton.styleFrom(
              backgroundColor: Theme.of(context).colorScheme.primary,
            ),
  ...
  void _showOrderOptionsDialog(BuildContext context, ItemsOrder order) {
        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              subtitle: const Text('Add these items to your cart'),
              onTap: () {
                Navigator.pop(context);
                _reorderItems(order);
              },
            ...
            ListTile(
              ...
              subtitle: const Text('Get help with this order'),
              onTap: () {
                Navigator.pop(context);
            ...
            ListTile(
              ...
              subtitle: const Text('Get order receipt'),
              onTap: () {
                Navigator.pop(context);
